...
*   GIF will only be animated in notification shade on Android 14+ (currently only available in the beta release)
:::
...
- `GIF` filetype will only be animated in notification shade on Android 14+ (currently only available in the beta release)
