...
9.  Go to Companion App Configuration -> Notifications -> Sounds.
...
3.  In the Home Assistant companion app, open the Companion App Configuration page from the sidebar.
...
1.  In the Home Assistant companion app, open the Companion App Configuration page from the Home Assistant Configuration menu.
...
6.  iOS sounds can now be used. You can view a the Companion App Configuration page under Notifications and then Sounds and System.
