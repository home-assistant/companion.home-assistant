...
| `end_live_activity` | Ends a Live Activity by its `tag`. [More details](live-activities.md#ending-a-live-activity). Requires iOS 17.2+; see [Live Activities requirements](live-activities.md#requirements). |
