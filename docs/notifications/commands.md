...
Some applications also require the class or component to be provided. For these applications you will need to provide the package as the `channel` and the full and complete class name under the `sticky` parameter. You will need to know what class name to provide as each application is different.
