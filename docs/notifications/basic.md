...
<img class='OSlogo' src='/assets/android.svg' alt='Android logo' /> Android users can achieve this through the use of [actionable notifications](/docs/notifications/actionable-notifications#building-automations-for-notification-actions) or [click action](#notification-click-action).
...
<img class='OSlogo' src='/assets/android.svg' alt='Android logo' />
...
<img class='OSlogo' src='/assets/apple.svg' alt='Apple logo' /> <img class='OSlogo' src='/assets/android.svg' alt='Android logo' />
