...
| `authenticationRequired` | **Optional**. `true` to require entering a passcode or use fingerprint to trigger the action. | <span class='beta'>BETA</span> on Android. Requires at least Android 12.  |
