...
On iOS 26.4 or later, you can add Assist and Assist prompts to the CarPlay **Quick Access** tab.
...
Adding Assist lets you start an Assist session from CarPlay, speak a request, and hear the response through your vehicle.
