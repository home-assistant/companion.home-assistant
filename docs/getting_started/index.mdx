...
:::note New onboarding experience
Starting with ![iOS](/assets/iOS.svg) app version 2025.11.0, there's a new streamlined onboarding process. [Learn more about the new onboarding](/docs/getting_started/#new-onboarding-ios-2025110).
:::
...
## New onboarding (![iOS](/assets/iOS.svg) 2025.11.0)
