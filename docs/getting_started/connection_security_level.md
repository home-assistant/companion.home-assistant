...
You can specify your Wi-Fi SSID (for example, "GrandmaHome5G") to be considered your home network, you can change this later in companion app settings anytime you want.
