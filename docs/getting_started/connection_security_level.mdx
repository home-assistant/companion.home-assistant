...
The app will block access and display a screen explaining the situation. Background activity (widgets, sensors, notifications) will also pause until a secure connection can be established.
