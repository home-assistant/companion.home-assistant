...
4.  Enter the Entity ID you wish to control. You can also enter multiple ID's, prioritized from left to right.
5.  If needed hide the Seek/Skip buttons or the media source label, or show the Volume buttons
