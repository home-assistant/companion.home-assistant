...
You may set the checkbox "Require authentication". If it is set, device credentials (i.e. PIN, pattern, biometrics ...) are required before the service call is initiated. <span class="beta">BETA</span>
