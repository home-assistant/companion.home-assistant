...
4.  Enter the Entity ID you wish to control. In the <span class="beta">BETA</span> you can also enter multiple ID's, prioritized from left to right.
5.  If needed hide the Seek/Skip buttons or the (<span class="beta">BETA</span>)media source label, or show the Volume buttons
