...
| `binary_sensor.focus` | None | Whether focus is currently enabled. Requires focus permission and iOS 15/macOS 12 update later this year. Will not work if Home Assistant is in the "Allowed Notifications" list, see [interruption level](../notifications/basic.md#interruption-level) for more. |
