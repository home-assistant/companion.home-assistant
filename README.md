...
- Docker
  ...
  - Windows 10 Home requires [WSL 2](https://docs.microsoft.com/windows/wsl/install) and the current Edge version of Docker Desktop (see instructions [here](https://docs.docker.com/desktop/windows/wsl/)). This can also be used for Windows Pro/Enterprise/Education.
